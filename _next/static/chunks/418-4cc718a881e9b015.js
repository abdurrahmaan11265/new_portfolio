    ...
    [418], {
        4309: function (e, t, i) {
            ...
            let r = [{
                ...
                data: [{
                    ...
                    id: 8,
                    type: "Email",
                    value: "abdurrahmaan11265@gmail.com"
                }
                    // ,{
                    // id: 9,
                    // type: "Skype",
                    ...
                    id: 10,
                    type: "Langages",
                    value: "English, Urdu, Telugu, Hindi, Arabic"
                }]
            }],
                c = [{
                    id: 1,
                    ...
                    , {
                    id: 4,
                    title: 'awards and certifications <span className="block">won</span>',
                    value: "23"
                }],
                d = [
                    {
                        id: 1,
                        date: "Dec 2024",
                        title: "Smart India Hackathon Finalist Project: Clarity - AI-Powered Career Counselling Platform",
                        company: "Government of India - SIH 2024",
                        desc: "Built a personalized career counselling platform that leverages AI and data-driven analytics to guide students in making informed career decisions. Developed using the MERN stack with seamless integration of assessment modules and recommendation systems."
                    },
                    {
                        id: 2,
                        date: "2024",
                        ...
                        desc: "Developed an AI platform to automatically generate engaging, high-quality educational videos. Integrated Python FastAPI, Node.js, React, LLMs, and FFmpeg to handle video synthesis and real-time content generation."
                    },
                    {
                        id: 3,
                        date: "Nov 2023 - May 2024",
                        title: "Internship in AI/ML",
                        company: "Wave Infotech",
                        desc: "Worked on real-time AI implementations and machine learning projects. Built predictive models, processed large datasets, and contributed to data-driven applications using Python and ML frameworks."
                    },
                    {
                        id: 4,
                        date: "2023",
                        title: "Sai Ganapathi Engineering College Official Website",
                        company: "College Project",
                        desc: "Developed the official college website using Django, HTML, CSS, AJAX, and REST APIs. Focused on responsive design, performance optimization, and seamless navigation for students and faculty."
                    },
                    {
                        id: 5,
                        date: "Jan - Jul 2023",
                        ...
                        desc: "Designed and implemented front-end web applications with modern frameworks. Collaborated with back-end teams to integrate REST APIs, ensuring responsive user interfaces and optimized performance."
                    },
                    {
                        id: 6,
                        date: "2022",
                        title: "Porto Generator",
                        company: "State level hackathon project",
                        desc: "Built an online tool to generate professional portfolios and resumes efficiently. Applied Node.js and Express.js, leveraging parallel algorithms for faster data handling and output generation."
                    },
                    {
                        id: 7,
                        date: "2021",
                        title: "Smart Robo Face: Personal Interactive Assistant",
                        company: "College Tech Fest Project",
                        desc: "Created an AI-enabled robotic interface with real-time motion tracking and conversational abilities. Combined Arduino, Python, and embedded systems for a dynamic and interactive user experience."
                    }
                ],
                u = [{
                    id: 1,
                    date: "2024 - 2028",
                    title: "Bachelor's Degree in Computer Science (Ongoing)",
                    unv: "Scaler School of Technology",
                    desc: "Currently pursuing a rigorous CS degree focused on advanced software development, system design, and project-based learning. The curriculum emphasizes real-world engineering practices, team collaboration, and industry-relevant skills."
                },
                {
                    id: 2,
                    date: "2024 - 2027",
                    title: "Bachelor's Degree in Computer Science (Online - WILP)",
                    unv: "Birla Institute of Technology and Science, Pilani",
                    desc: "Enrolled in BITS Pilani's Work Integrated Learning Program, focusing on computer science fundamentals, data structures, algorithms, and industry-oriented problem solving, all while working on real-time projects to gain professional exposure."
                }, {
                    id: 3,
                    date: "2020 - 2024",
                    title: "Diploma In Computer Engineering",
                    unv: "Sai Ganapathi Polytechnic",
                    desc: "Throughout this program, I gained comprehensive knowledge and practical skills in various areas of computer engineering, including software development, hardware design, networking, and systems analysis."
                }, {
                    id: 4,
                    date: "2017 - 2021",
                    title: "Diploma in Islamic Sciences",
                    unv: "Falah High School",
                    desc: "Through this program I immersed in the rich intellectual tradition of Islamic studies, covering a diverse range of topics including Qur'anic studies, Hadith, Islamic jurisprudence, theology, history, and ethics."
                }, {
                    id: 5,
                    date: "2021",
                    title: "Class X",
                    unv: "Falah High School",
                    desc: "During this pivotal academic year, I demonstrated a strong commitment to excellence in both my studies and extracurricular pursuits. Achieving high grades in core subjects, I showcased my dedication to academic success."
                }],
                m = [{
                    id: 1,
                    name: "MERN Stack",
                            ...
                            children: [(0, a.jsxs)("div", {
                                ...
                                children: [(0, a.jsxs)("div", {
                                    ...
                                    children: [(0, a.jsx)("h3", {
                                        ...
                                        src: "assets/img/dark-img-mobile.png",
                                        alt: ""
                                    }), (0, a.jsx)("div", {
        ...
        2622: function (e, t, i) {
            ...
            var a = i(7437),
                    ...
                    return (0, a.jsx)(o.Z, {
                        ...
                        children: (0, a.jsxs)("div", {
                            ...
                            children: [(0, a.jsx)(r.Z, {
                                ...
                                className: "mx-auto max-w-700 down-sm:px-25 xs:pt-85",
                                children: [(0, a.jsxs)("div", {
                                    className: "text-fs-13 text-".concat(i ? "light-grey" : "black-3", " font-Open-sans"),
                                    children: [(0, a.jsxs)("span", {
                                        className: "pr-15",
                                        children: [(0, a.jsx)("i", {
                                            className: "fa fa-user pr-3 text-accent"
                                        }), " ", t.author]
                                    }), (0, a.jsxs)("span", {
                                        className: "pr-15",
                                        children: [(0, a.jsx)("i", {
                                            className: "fa fa-calendar pr-3 text-accent"
                                        }), " ", t.date]
                                    }), (0, a.jsxs)("span", {
                                        className: "pr-15",
                                        children: [(0, a.jsx)("i", {
                                            className: "fa fa-tags pr-3 text-accent"
                                        }), " ", t.tags]
                                    })]
                                }), (0, a.jsx)("h1", {
                                    className: "mt-13 mb-20 font-semibold capitalize text-fs-40 xs:text-fs-26 leading-lh-1.2",
                                    children: t.title
                                }), (0, a.jsx)("img", {
                                    className: "rounded-5 mb-20 w-full",
                                    src: t.img,
                                    alt: "img"
                                }), (0, a.jsxs)("div", {
                                    className: "font-Open-sans mb-60",
                                    children: [(0, a.jsx)("p", {
                                        className: "mb-32 leading-lh-30",
                ...
                d = () => {
                    let [e, t] = (0, n.useState)(1), [i, d] = (0, n.useState)([]);
                    (0, n.useEffect)(() => {
                        l.x.pagination(".blog-list-item", 3, e);
                        let t = document.querySelectorAll(".blog-list-item");
                        d(l.x.getPagination(t.length, 3))
                    }, [e]);
                    let {
                        blogs: u,
                        changeNav: m,
                        dark: p
                    } = (0, n.useContext)(s.TunisContext), [x, f] = (0, n.useState)(null);
        ...
        7741: function (e, t, i) {
            ...
            let x = [{
                id: 1,
                icon: "fa fa-linkedin",
                link: "https://www.linkedin.com/in/mohammad-abdur-rahman-9a30aa276/"
            }, {
                id: 2,
                icon: "fa fa-instagram",
                link: "https://www.instagram.com/mohammed__abdurrahmaan/"
            }, {
                id: 3,
                icon: "fa fa-github",
                link: "https://github.com/abdurrahmaan11265"
            }];
            var f = () => {
                let {
                    dark: e
                } = (0, m.useContext)(s.TunisContext), [t, i] = (0, m.useState)({
                    name: "",
                    email: "",
                    subject: "",
                    message: "",
                    ...
                    message: c,
                    template: d
                } = t, [f, b] = (0, m.useState)(null), h = e => i({
                    ...t,
                    [e.target.name]: e.target.value
                }), g = e => {
                    e.preventDefault(), 0 === l.length || 0 === n.length || 0 === r.length || 0 === c.length ? (b(!0), v()) : u.send("service_gsps4gw", "template_evezi69", t, "Q3pccdLZhU-mZT7tQ").then(e => {
                        b(!1), v(), i({
                            name: "",
                            email: "",
                            message: "",
                    ...
                    children: (0, a.jsxs)("div", {
                        ...
                        children: [(0, a.jsx)(p.Z, {
                            ...
                            children: (0, a.jsxs)("div", {
                                ...
                                children: [(0, a.jsxs)("div", {
                                    className: "w-1/3 down-lg:w-full px-16 xs:px-0",
                                    children: [(0, a.jsx)("h3", {
                                        className: "text-fs-26 xs:text-fs-21 mb-16 font-semibold uppercase",
                                        children: "don't be shy !"
                                    }), (0, a.jsx)("p", {
                                        className: "mb-16 font-Open-sans text-fs-15 xs:text-fs-14",
                                    ...
                                    className: "w-2/3 down-lg:w-full px-16 down-lg:px-0",
                                    children: (0, a.jsx)("form", {
                                        id: "contactform",
                                        className: "contactform",
                                        action: "https://docs.google.com/forms/d/e/1FAIpQLSfpHUNH7y8b-lcOwlCRbXI_Xm2Q6zqFR0p9-JhylCWcn0EKWQ/formResponse",
                                        // onSubmit: e => g(e),
                                        children: (0, a.jsxs)("div", {
                                            className: "flex flex-wrap font-normal",
                                            children: [(0, a.jsx)("div", {
                                                className: "from-sm:w-1/3 down-sm:w-full px-16 xs:px-0",
                                                children: (0, a.jsx)("input", {
                                                    autoComplete: "off",
                                                    className: "w-full ".concat(e ? "bg-black-3" : "", " text-fs-15 text-").concat(e ? "white" : "black-6", " border border-solid border-").concat(e ? "black" : "grey", " py-11 px-26 mb-30 rounded-30 outline-0 transition duration-300 placeholder:text-placeholder field-form"),
                                                    type: "text",
                                                    name: "entry.493328957",
                                                    // onChange: e => h(e),
                                                    // value: l,
                                                ...
                                                children: (0, a.jsx)("input", {
                                                    ...
                                                    className: "w-full ".concat(e ? "bg-black-3" : "", " text-fs-15 text-").concat(e ? "white" : "black-6", " border border-solid border-").concat(e ? "black" : "grey", " py-11 px-26 mb-30 rounded-30 outline-0 transition duration-300 placeholder:text-placeholder field-form"),
                                                    type: "text",
                                                    name: "entry.333701748",
                                                    // onChange: e => h(e),
                                                    // value: r,
                                                    placeholder: "YOUR SUBJECT"
                                                })
                                            }), (0, a.jsx)("div", {
                                                className: "w-full px-16 xs:px-0",
                                                children: (0, a.jsx)("textarea", {
                                                    className: "w-full ".concat(e ? "bg-black-3" : "", " text-fs-15 text-").concat(e ? "white" : "black-6", " border border-solid border-").concat(e ? "black" : "grey", " h-160 py-11 px-26 rounded-30 outline-0 transition duration-300 placeholder:text-placeholder field-form"),
                                                    placeholder: "YOUR MESSAGE",
                                                    defaultValue: "",
                                                    name: "entry.1108395654",
                                                    // onChange: e => h(e),
                                                    // value: c
                                                })
                                            }), (0, a.jsx)("div", {
                                                className: "w-full px-16 xs:px-0 mt-30",
                                                children: (0, a.jsxs)("button", {
                                                    ...
                                                    // },
                                                    children: [(0, a.jsx)("span", {
                                                        className: "relative z-20 ".concat(e ? "text-white" : "text-black-6 group-hover:text-white transition-all duration-300"),
                                                        children: "send message"
                                                    }), (0, a.jsx)("span", {
                                                        className: "absolute -right-px bottom-0 w-55 h-55 flex items-center justify-center rounded-full text-white text-fs-19 fa fa-send bg-accent"
                                                    })]
                                                })
                                            })
                                                //     , (0, a.jsx)("div", {
        ...
        8635: function (e, t, i) {
            ...
            t.default = e => {
                ...
                return (0, a.jsxs)(o.Z, {
                    id: "home",
                    children: [(0, a.jsx)("div", {
                        className: "bg-accent fixed w-full h-200prcnt -rotate-15 -top-1/2 -left-83prcnt hidden from-lg:block"
                    }), (0, a.jsxs)("div", {
                        className: "flex items-center h-screen w-full down-lg:mx-auto down-lg:justify-center xs:text-left down-lg:text-center ",
                        children: [(0, a.jsx)("img", {
                            className: "hidden from-lg:block fixed w-1/3 h-[calc(100vh-80px)] left-40 top-40 rounded-30 shadow-1 object-cover",
                            src: t || "assets/img/dark.png",
                            alt: ""
                        }), (0, a.jsx)("div", {
                            className: "from-lg:ml-100/3 from-lg:w-2/3",
                            children: (0, a.jsxs)("div", {
                                className: "mx-auto max-w-550 custom-md-1:max-w-450",
                                children: [(0, a.jsx)("img", {
                                    src: "assets/img/dark-img-mobile.png",
                                    ...
                                    children: ["I'm Mohammed.", (0, a.jsx)("span", {
                                    ...
                                    children: `I'm Mohammed Abdurrahman, a Computer Science student with expertise
                                        in Full - Stack Development, AI/ ML and Data Analysis. With a track
record of building innovative web applications and a strong problem - solving skill set, I'm eager to contribute my talents to drive excellence and
innovation in your organization.`
                                    ...
                                    onClick: () => i("about"),
                                    children: [(0, a.jsx)("span", {
                                        className: "relative z-20 ".concat(n ? "text-white" : "text-black-6 group-hover:text-white transition-all duration-300"),
                    ...
                    children: (0, a.jsxs)("div", {
                        ...
                        children: [(0, a.jsx)(n.Z, {
                            ...
                            children: (0, a.jsx)("div", {
                                ...
                                children: (0, a.jsx)("div", {
                                    className: "grid-wrap mx-auto mb-25",
                                    children: (0, a.jsx)("ul", {
                                        className: "gridlist",
                                        children: r.map(t => (0, a.jsx)("li", {
                                            ...
                                            children: (0, a.jsxs)("figure", {
                                                ...
                                                children: [(0, a.jsx)("img", {
                                                    ...
                                                    className: "absolute w-full h-full flex items-center justify-center bg-accent",
                                                    children: (0, a.jsx)("span", {
                                                        className: "uppercase text-fs-18 text-white",
                                                        children: t.title
                                                    })
                                                })]
                                            })
        ...
        5770: function (e, t, i) {
            ...
            t.Z = e => {
                let {
                    ...
                    dark: n
                } = (0, o.useContext)(s.TunisContext);
                return (0, a.jsxs)("div", {
                    className: "mx-auto w-full relative py-80 text-center xs:px-25 xs:pt-16 xs:pb-14 xs:bg-black-3 xs:border-b xs:border-black-4 xs:fixed xs:left-0 xs:right-0 xs:top-0 xs:z-20",
                    children: [(0, a.jsxs)("h2", {
                        className: "text-fs-56 font-black font-Poppins uppercase text-".concat(n ? "white" : "black-6", " m-0 xs:text-fs-26 xs:text-left xs:leading-lh-1.2"),
                        children: [l, " ", (0, a.jsx)("span", {
                            className: "text-accent",
                            children: i
                        })]
                    }), (0, a.jsx)("span", {
                        className: "text-fs-110 absolute left-0 right-0 top-1/2 tracking-10 leading-lh-0.7 font-extrabold text-".concat(n ? "muted" : "light-grey-2", " -translate-y-1/2 uppercase xs:hidden"),
                        children: t
                    })]
                })
            }
        ...
        2046: function (e, t, i) {
            ...
            t.default = e => {
                let {
                    children: t
                } = e, [i, x] = (0, s.useReducer)(p, m), f = (0, s.useCallback)((e, t) => {
                    x({
                        type: l,
                        payload: e
                    }), x({
            ...
            var a = i(7437),
                ...
                l = () => {
                    let {
                        nav: e,
                        direction: t
                    } = (0, o.useContext)(s.TunisContext), [i, l] = (0, o.useState)(""), {
                        width: n,
                        height: r
                    } = function () {
                        let [e, t] = o.useState({
                        ...
                        return o.useEffect(() => (window.addEventListener("resize", i), () => {
                            window.removeEventListener("resize", i)
                        }), []), e
                    }();
                    return (0, o.useEffect)(() => {
                        setTimeout(() => {
                            l("revealer--".concat(t, " revealer--animate opacity-100"))
                        }, 100), setTimeout(() => {
                            l("")
                        }, 1500)
                    }, [e]), (0, a.jsxs)("div", {
                        className: "revealer ".concat(i),
                        style: (e => {
                            let t = Math.sqrt(Math.pow(n, 2) + Math.pow(r, 2));
                            switch (e) {
                                case "cornertopleft":
                                    return {
                                        width: t, height: t, transform: "translate3d(-50%, -50%, 0px) rotate3d(0, 0, 1, 135deg) translate3d(0px, ".concat(t, "px, 0px)")
                                    };
                                case "top":
                                default:
                                    return {
                                        width: "100vw", height: "100vh", transform: "rotate3d(0, 0, 1, 180deg)"
                                    };
                                case "cornertopright":
                                    return {
                                        width: t, height: t, transform: "translate3d(-50%, -50%, 0px) rotate3d(0, 0, 1, -135deg) translate3d(0px, ".concat(t, "px, 0px)")
                                ...
                                case "left":
                                    return {
                                        width: "100vh", height: "100vw", transform: "translate3d(-50%, -50%, 0px) rotate3d(0, 0, 1, 90deg) translate3d(0px, 100%, 0px)"
                                    };
                                case "right":
                                    return {
                                        width: "100vh", height: "100vw", transform: "translate3d(-50%, -50%, 0px) rotate3d(0, 0, 1, -90deg) translate3d(0px, 100%, 0px)"
                                ...
                                case "cornerbottomleft":
                                    return {
                                        width: t, height: t, transform: "translate3d(-50%, -50%, 0px) rotate3d(0, 0, 1, 45deg) translate3d(0px, ".concat(t, "px, 0px)")
                                    };
                                case "bottom":
                                    return {
        ...
        8692: function (e, t, i) {
            ...
            t.Z = e => {
                let {
                    ...
                    nav: l,
                    direction: n
                } = (0, o.useContext)(s.TunisContext), [r, c] = (0, o.useState)("page--animate-".concat(n));
                return (0, o.useEffect)(() => {
                    setTimeout(() => {
                        c(l === i ? "page--current" : "page--animate-".concat(n))
                    }, 1e3)
                }, [l]), (0, a.jsx)("div", {
                    className: "page ".concat(r),
                    id: i,
                    children: t
                })
            }
        ...
        2427: function (e, t, i) {
            ...
            var a = i(7437),
                ...
                l = () => {
                    ...
                    return (0, a.jsx)("a", {
                        href: "#",
                        className: "dark-switch social-item flex h-50 w-50 leading-lh-42 text-center transition duration-300 text-fs-20 mx-6 bg-".concat(t ? "black-2" : "light-grey", " rounded-full"),
                        onClick: () => e(!t),
                        children: (0, a.jsx)("i", {
                            className: "".concat(t ? "fa fa-sun-o text-white" : "fa fa-moon-o text-black-6", " text-fs-20")
                        })
                    })
                },
                n = () => {
                    ...
                    return (0, a.jsx)("div", {
                        ...
                        children: (0, a.jsx)("div", {
                            ...
                            children: (0, a.jsxs)("div", {
                                className: "slideshow bg-black",
                                children: [(0, a.jsxs)("figure", {
                                    className: "popup_figure bg-".concat(i ? "black-3" : "white", " p-30 overflow-auto rounded-10"),
                                    children: [(0, a.jsxs)("figcaption", {
                                        className: "mb-15",
                                        children: [(0, a.jsx)("h3", {
                                            className: "uppercase leading-lh-1.2 text-accent pt-10 pb-28 font-bold text-center text-fs-33",
                                            children: e.title
                                        }), (0, a.jsxs)("div", {
                                            className: "flex flex-wrap font-Open-sans text-fs-15",
                                            children: [(0, a.jsxs)("div", {
                                                className: "w-1/2 xs:w-full mb-8",
                                                children: [(0, a.jsx)("i", {
                                                    className: "fa fa-file-text-o pr-8"
                                                }), (0, a.jsx)("span", {
                                                ...
                                                , (0, a.jsxs)("div", {
                                                    ...
                                                    className: "w-1/2 xs:w-full mb-8",
                                                    children: [(0, a.jsx)("i", {
                                                        className: "fa fa-external-link pr-8"
                                                    }), (0, a.jsx)("span", {
                                                        className: "project-label",
                                                        children: "Preview "
                                                    }), ":", " ", (0, a.jsx)("span", {
                                                        ...
                                                        children: (0, a.jsx)("a", {
                                                            ...
                                                            href: e.previewLink,
                                                            target: "_blank",
                                                            children: e.previewLink
                                                        })
                                                    })]
                                                })]
                                        })]
                                    }), "local_video" == e.type ? (0, a.jsx)("video", {
                                        id: "video",
                                    ...
                                    className: "down-lg:fixed down-lg:top-0 down-lg:w-full down-lg:h-102 down-lg:bg-black-3 down-lg:z-10 down-lg:border-b down-lg:border-solid down-lg:border-b-black-4 xs:h-62",
                                    children: (0, a.jsxs)("span", {
                                        onClick: () => t(null),
                                        // asdf
                                        ...
                                        children: [(0, a.jsx)("img", {
                                            className: "block nav-close-button",
                                            src: "assets/img/projects/close-button.png",
                                            alt: "close"
                                        }), " "]
                                    })
                                })]
            ...
            var p = () => (0, a.jsxs)(o.Fragment, {
                ...
                x = () => {
                    ...
                    return (0, a.jsxs)("header", {
                        ...
                        children: [(0, a.jsx)("ul", {
                            ...
                            children: e.map(e => (0, a.jsxs)("li", {
                                className: "desktop-nav-element cursor-pointer w-50 h-50 relative flex items-center transition duration-300 my-20 mx-0 rounded-full ".concat(l ? "bg-black-2" : "bg-light-grey", " ").concat(t.includes(e.href) ? "active" : ""),
                                onClick: () => i(e.href),
                                children: [(0, a.jsx)("i", {
                            ...
                            children: (0, a.jsxs)("div", {
                                ...
                                children: [(0, a.jsx)("input", {
                                    ...
                                    className: "flex h-0.5 w-23 mb-5 relative bg-white z-10 rounded-3 origin-0 custom-transition peer-checked:rotate-45 peer-checked:translate-x-1 peer-checked:translate-y-0"
                                }), (0, a.jsx)("span", {
                                    className: "flex h-0.5 w-23 mb-5 relative bg-white z-10 rounded-3 origin-0-100 custom-transition peer-checked:opacity-0 peer-checked:scale-0-2"
                                }), (0, a.jsx)("span", {
                                    className: "flex h-0.5 w-23 mb-5 relative bg-white z-10 rounded-3 origin-0-100 custom-transition peer-checked:-rotate-45 peer-checked:translate-x-2 peer-checked:translate-y-2"
                                }), (0, a.jsx)("ul", {
                                    ...
                                    children: e.map(e => (0, a.jsx)("li", {
                                        className: "mobile-nav-element ".concat(t == e.href ? "active" : "", " relative pl-30"),
                                        children: (0, a.jsxs)("div", {
                                            ...
                                            children: [(0, a.jsx)("i", {
                                                ...
                                                className: "absolute left-50 xs:left-35 font-normal",
                                                children: e.title
                                            })]
                                        })
                                    }, e.id))
                ...
                f = e => {
                    ...
                    return (0, o.useEffect)(() => {
                        ...
                        className: "home ".concat(u ? "dark" : "", " bg-").concat(u ? "black" : "white", " text-").concat(u ? "white" : "black-6", " relative w-full h-full overflow-hidden anim--effect-3 animation-").concat(i),
                        children: [(0, a.jsx)(c, {}), d && (0, a.jsx)(n, {}), (0, a.jsx)(l, {}), (0, a.jsx)(x, {}), t, (0, a.jsx)(p, {})]
                    })
                }
        },
        9174: function (e, t, i) {
            ...
            let a = {
                preloader() {
                    let e = !!/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent),
                        t = document.getElementById("preloader");
                    t && (e ? t.remove() : (setTimeout(function () {
                ...
                getPagination: (e, t) => Array(Math.ceil(e / t)).fill().map((e, t) => t + 1),
                pagination(e, t, i) {
                    let a = document.querySelectorAll(e);
                    for (let e = 0; e < a.length; e++) {
                        let s = a[e];
                        1 === i ? e < t ? s.classList.remove("d-none") : s.classList.add("d-none") : e >= (i - 1) * t && e < i * t ? s.classList.remove("d-none") : s.classList.add("d-none")
                    }
                },
                customCursor() {
                    var e = document.querySelectorAll(".mouse-cursor"),
                        t = document.querySelector(".hamburger"),
                        i = document.querySelector(".kura_tm_topbar "),
                        a = document.querySelectorAll(".cursor-pointer"),
                        s = document.querySelector(".cursor-inner"),
                        o = document.querySelector(".cursor-outer");

                    function l(e) {
                        e.addEventListener("mouseenter", function () {
                            s.classList.add("cursor-hover"), o.classList.add("cursor-hover")
                        }), e.addEventListener("mouseleave", function () {
                            s.classList.remove("cursor-hover"), o.classList.remove("cursor-hover")
                        })
                    }
                    e.length && document.body && (window.onmousemove = function (e) {
                        o.style.transform = "translate(" + e.clientX + "px, " + e.clientY + "px)", s.style.transform = "translate(" + e.clientX + "px, " + e.clientY + "px)", e.clientY, e.clientX
                    }, document.body.addEventListener("mouseenter", function () {
                        let e = document.querySelectorAll("a");
                        s.classList.add("cursor-inner"), o.classList.add("cursor-outer");
                        for (let t = 0; t < e.length; t++) l(e[t]);
                        for (let e = 0; e < a.length; e++) l(a[e]);
                        t && l(t), i && l(i)
                    }), s.style.visibility = "visible", o.style.visibility = "visible")
                }
            }
        },
        622: function (e, t, i) {
            ...
            function r(e, t, i) {
                var a, r = {},
                    c = null,
                    d = null;
                for (a in void 0 !== i && (c = "" + i), void 0 !== t.key && (c = "" + t.key), void 0 !== t.ref && (d = t.ref), t) o.call(t, a) && !n.hasOwnProperty(a) && (r[a] = t[a]);
                if (e && e.defaultProps)
